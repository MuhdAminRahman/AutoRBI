...
class NewWorkView:
    ...
    def __init__(self, parent: ctk.CTk, controller):
        ...
        self.work_id = self.controller.current_work.get("work_id") if self.controller.current_work else None
        self.workpathname = self.controller.current_work.get("work_name") if self.controller.current_work else None
